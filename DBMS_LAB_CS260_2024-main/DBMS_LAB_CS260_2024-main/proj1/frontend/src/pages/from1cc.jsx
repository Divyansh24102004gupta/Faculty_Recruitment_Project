...
function Form1() {
  ...
  */}
  ...
  const [pinzip, setPinZip] = useState("");
  const [Street2, setStreet2] = useState("");
  const [City2, setCity2] = useState("");
  const [State2, setState2] = useState("");
  const [Country2, setCountry2] = useState("");
  const [pinzip2, setPinZip2] = useState("");
  ...
  const handleSubmit = async (e) => {
    ...
    //   const response = await axios.post("http://localhost:3000/auth/form1", formData);
        ...
        <div className="Address card">
          <div className="correspondance">
            ...
            <textarea
              className="text-area"
              placeholder="PIN/ZIP"
              onChange={(e) => setPinZip(e.target.value)}
              name="PIN/ZIP"
              id="PIN/ZIP"
              cols="50"
              rows="3"
          ...
          <div className="permanent">
            ...
            <textarea
              className="text-area"
              placeholder="PIN/ZIP"
              onChange={(e) => setPinZip2(e.target.value)}
              name="PIN/ZIP"
              id="PIN/ZIP"
              cols="50"
              rows="3"
