...
function Form1() {
  ...
  useEffect(() => {
    const isLoggedIn = async () => {
      try {
        await instance
          .post("http://localhost:8000/api/v1/users/isloggedin")
          .then((response) => {
  ...
  useEffect(() => {
    const formdata = async () => {
      try {
        await instance
          .get("http://localhost:8000/api/v1/forms/gettingform1")
          .then((response) => {
            ...
            setData((prev) => ({
              ...prev,
              applicationnumber: String(user.applicationId),
            }));
            ...
            if (dataFromBackend.form1Data) {
              ...
              setData((prev) => ({
                ...prev,
                advertisementnumber: formdata.advertisementnumber,
              }));
          ...
          .catch((error) => {
            ...
            const preContent = String(
              htmlResponse.match(/<pre>(.*?)<\/pre>/s)[1]
            );
  ...
  const form1submit = async (e) => {
    ...
    try {
      await instance
        .post("http://localhost:8000/api/v1/forms/submittingform1", formData, {
        ...
        <form onSubmit={form1submit}>
            ...
            <div className="mx-3 flex justify-between">
              ...
              <div className="mt-3 flex justify-between gap-4">
                <Link to="/change-password">
                  <div className="bg-blue-500 text-white tx-sm text-nowrap px-1 py-1 rounded-sm hover:bg-blue-600 cursor-pointer ">
                    Change password
                  </div>
                </Link>
                <Logout />
            ...
            <div className="flex-col xl:flex xl:flex-row w-full">
              <div className=" w-full">
                <div className="flex-col xl:flex xl:flex-row p-2 m-2 justify-between gap-3">
                  <label htmlFor="advertisementnumber">
                    <div className=" text-nowrap w-48 font-semibold">
                      Advertisement Number *
                    </div>
                  </label>
                  <select
                    value={data.advertisementnumber}
                    onChange={(e) =>
                      setData({ ...data, advertisementnumber: e.target.value })
                    }
                    autoFocus
                    required
                    id="advertisementnumber"
                    name="advertisementnumber"
                    className="focus:outline-transparent inline-block focus-visible:ring p-1 w-full border rounded-sm"
                  >
                    <option value="">Select</option>
                    <option value="IITP/FACEREC-CSE/2023/JULY/02">
                      IITP/FACEREC-CSE/2023/JULY/02
                    </option>
                  </select>
                </div>
                <div className="flex-col xl:flex xl:flex-row p-2 m-2 justify-between gap-3">
                  ...
                  <input
                    ...
                    className="inline-block  focus:outline-transparent bg-slate-200 border-gray-500 shadow-md focus-visible:ring p-1 border w-full rounded-sm"
                  />
                </div>
                <div className="flex-col xl:flex xl:flex-row p-2 m-2 justify-between gap-3">
              ...
              <div className=" w-full">
                <div className="flex-col xl:flex xl:flex-row p-2 m-2 justify-between gap-3">
                  ...
                  <input
                    ...
                    className="inline-block bg-slate-200 border-gray-500 shadow-md focus:outline-transparent  focus-visible:ring p-1 border w-full rounded-sm"
                  />
                </div>
                ...
                <div className="flex-col xl:flex xl:flex-row p-2 m-2 justify-between gap-3">
                  ...
                  >
                    ...
                    <option value="Assistant Professor Grade I">
                      Assistant Professor Grade I
                    </option>
                    <option value="Assistant Professor Grade II">
              ...
              <div className=" w-full">
                <div className="flex-col xl:flex xl:flex-row p-2 m-2 justify-between gap-3">
                  ...
                  <input
                    ...
                    id="firstname"
                    name="firstname"
                    className="inline-block  focus:outline-transparent  focus-visible:ring p-1 border w-full rounded-sm"
                  />
                </div>
                <div className="flex-col xl:flex xl:flex-row p-2 m-2 justify-between gap-3">
                ...
                <div className="flex-col xl:flex xl:flex-row p-2 m-2 justify-between gap-3">
                  ...
                  <input
                    value={data.dob}
                    pattern="\d{2}/\d{2}/\d{4}"
                    title="Enter a date in the format dd/mm/yyyy"
              ...
              <div className=" w-full">
                <div className="flex-col xl:flex xl:flex-row p-2 m-2 justify-between gap-3">
                  <label htmlFor="fathername">
                    <div className=" w-48 font-semibold">Father's Name *</div>
                  </label>
                  <input
                ...
                <div className="flex-col xl:flex xl:flex-row p-2 m-2 justify-between">
                  ...
                  <div className="flex flex-row justify-between">
                    <div
                      className="bg-green-500 text-white tx-sm text-nowrap px-1 py-1 rounded-sm hover:bg-green-600 cursor-pointer "
                      onClick={showImage}
                    >
                      View uploaded file
                    </div>
                    <input
                      onChange={(e) =>
                        setData((prev) => ({
                          ...prev,
                          updateidproof: e.target.files[0],
                        }))
                      }
                      type="file"
                      id="updateidproof"
                      name="updateidproof"
                      accept="image/*"
                      className="inline-block  focus:outline-transparent  focus-visible:ring p-1 border w-1/2 rounded-sm"
                    />
                  </div>
                </div>
              </div>
              <div className=" w-full xl:w-60 ">
                <div className="h-48 w-48  shadow-md shadow-blue-500 rounded-md m-5 ">
                  <img
                    src={imageurl}
                    alt="uploaded image"
                    className="h-48 w-48"
                ...
                <input
                  ...
                  name="updateimage"
                  accept="image/*"
                  className="inline-block  focus:outline-transparent  focus-visible:ring p-1 w-60 border rounded-sm"
                />
              </div>
            </div>
          </div>
          ...
          <div className="flex flex-wrap justify-between  bg-white border-2 border-black rounded-lg shadow-xl hover:shadow-blue-300 xl:p-0 m-3 mt-6">
            <div className="flex-col xl:flex xl:flex-row w-full justify-between gap-4 mx-4">
              <div className=" w-full">
                <div className=" text-nowrap w-48 font-semibold h-10 mt-2">
                ...
                <textarea
                  ...
                  name="Street"
                  rows="1"
                  className="mb-4 inline-block  focus:outline-transparent  focus-visible:ring p-1 border w-full rounded-sm"
                ></textarea>
                <textarea
                  value={data.City}
                ...
                <textarea
                  value={data.pinzip}
                  onChange={(e) => setData({ ...data, pinzip: e.target.value })}
                  required
                  placeholder="PIN/ZIP"
                  id="pinzip"
                  name="pinzip"
              ...
              <div className=" w-full">
                ...
                <textarea
                  value={data.City2}
                  onChange={(e) => setData({ ...data, City2: e.target.value })}
                  required
                  placeholder="City"
                  id="City2"
                  name="City2"
                ...
                <textarea
                  value={data.State2}
                  onChange={(e) => setData({ ...data, State2: e.target.value })}
                  required
                  placeholder="State"
                  id="State2"
                  name="State2"
                ...
                <textarea
                  value={data.Country2}
                  onChange={(e) =>
                    setData({ ...data, Country2: e.target.value })
                  }
                  required
                  placeholder="Country"
                  id="Country2"
                ...
                <textarea
                  value={data.pinzip2}
                  onChange={(e) =>
                    setData({ ...data, pinzip2: e.target.value })
                  }
                  required
                  placeholder="PIN/ZIP"
                  id="pinzip2"
          ...
          <div className="flex flex-wrap justify-between  bg-white border-2 border-black rounded-lg shadow-xl hover:shadow-blue-300 xl:p-0 m-3 mt-6">
            <div className="flex-col xl:flex xl:flex-row w-full justify-between gap-4 mx-4">
              <div className="w-full">
                ...
                <div className="flex-col xl:flex xl:flex-row p-2 m-2 justify-between gap-3">
                  ...
                  <input
                    ...
                    pattern="[0-9]{10}"
                    onChange={(e) =>
                      setData({ ...data, altmobile: e.target.value })
                    }
                    type="text"
                ...
                <div className="flex-col xl:flex xl:flex-row p-2 m-2 justify-between gap-3">
                  ...
                  <input
                    ...
                    title="Landline number with area code and remaining 8 digits (0-9)"
                    pattern="[0-9]{3}[0-9]{4}[0-9]{4}"
                    onChange={(e) =>
                      setData({ ...data, landlinenumber: e.target.value })
                    }
                    type="text"
              ...
              <div className=" w-full">
                <div className="flex-col xl:flex xl:flex-row p-2 m-2 justify-between gap-3">
                  <label htmlFor="email">
                    <div className=" text-nowrap w-48 font-semibold">Email</div>
                  </label>
                  <input
                    value={data.email}
                    readOnly
                    ...
                    id="email"
                    name="email"
                    className="inline-block  focus:outline-transparent  focus-visible:ring p-1 border w-full bg-slate-200 border-gray-500 shadow-md rounded-sm"
                  />
                </div>
                <div className="flex-col xl:flex xl:flex-row p-2 m-2 justify-between gap-3">
